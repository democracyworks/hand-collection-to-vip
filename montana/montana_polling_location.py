...
class PollingLocationTxt(object):
    ...
    def get_address_line(self, index, street, city, state, zip_code):
        ...
        if not pd.isnull(street):
            ...
            raise ValueError("Missing value at row " + str(index) + '.')
        ...
        address_line = street + ", " + city_name + ", MT " + zip
        print address_line
        return address_line
    ...
    def create_hours_open_id(self, index, street, city, state, zip_code):
        """#"""
...
#        return plt
    ...
    def write_polling_location_txt(self):
        ...
        # Drop base_df columns.
        plt.drop(['index', 'office_name', 'official_title', 'types', 'ocd_division', 'division_description',
                'phone', 'email', 'street', 'city', 'state', 'zip_code', 'start_time', 'end_time', 'start_date',
                'end_date', 'notes'], inplace=True, axis=1)
