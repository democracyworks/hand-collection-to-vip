...
class ElectionTxt(object):
    ...
    def create_id(self):
        ...
        """
        # TODO: use fips code
        for key, value in config.state_dict.iteritems():
    ...
    def write_election_txt(self):
        output_path = "/home/acg/democracyworks/hand-collection-to-vip/montana/election_test.csv"
        ...
        try:
            ...
            writer.writerow({'id': self.create_id(), # TODO: call methods
                             'date': self.get_date(),
                             'name':  self.get_name(),
...
def main():
    ...
    early_voting_file = "/home/acg/democracyworks/hand-collection-to-vip/election/" + input
