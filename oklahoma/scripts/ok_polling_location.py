...
class PollingLocationTxt(object):
    ...
    def get_address_line(self, index, address, city, zip_code):
        ...
        line= adr.strip() + ", " + city.strip() + ", OK " + zip
        print line, index
        return line
    ...
    def build_polling_location_txt(self):
        ...
        self.base_df['address_line'] = self.base_df.apply(
            lambda row: self.get_address_line(row['index'], row['street'], row['city'],
                                              row['zip']), axis=1)
    ...
    def write_polling_location_txt(self):
        ...
        plt.drop(['office_name', 'title', 'ocd_division', 'description', 'homepage', 'phone', 'email', 'loc_name', 'street', 'city', 'state', 'zip',
...
if __name__ == '__main__':
    ...
    #drop_box_true =
    state_file='oklahoma_early_voting_info.csv'
    ...
    colnames = ['office_name', 'title', 'ocd_division', 'description', 'homepage', 'phone', 'email', 'loc_name', 'street', 'city', 'state', 'zip',
