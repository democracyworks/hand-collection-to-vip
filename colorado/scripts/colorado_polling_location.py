...
class PollingLocationTxt(object):
    ...
    def write_polling_location_txt(self):
        ...
        plt.drop(['loc_name', 'adr_1', 'adr_2', 'adr_3', 'city', 'state', 'zip', 'dirs', 'county', 'services', 'start_date',
                'end_date', 'start_time', 'end_time', 'index'], inplace=True, axis=1)
...
if __name__ == '__main__':
    ...
    #drop_box_true =
    state_file='colorado_early_voting_info.csv'
    ...
    colnames = ['loc_name', 'adr_1', 'adr_2', 'adr_3', 'city', 'state', 'zip', 'dirs', 'county', 'services', 'start_date',
