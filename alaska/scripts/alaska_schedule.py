...
import pandas as pd
import config
from alaska_polling_location import PollingLocationTxt
import datetime
import re
...
class ScheduleTxt(object):
    ...
    def write_schedule_txt(self):
        ...
        # Drop base_df columns.
        sch.drop(['office', 'name', 'adr_1', 'adr_2', 'dirs', 'city', 'state', 'zip',
                'start_time', 'end_time',  'start_date', 'end_date', 'appt', 'ocd-id','address_line', 'directions',
                'hours', 'photo_uri', 'hours_open_id', 'is_drop_box', 'is_early_voting', 'lat', 'long', 'latlng', 'id', 'index'], inplace=True,
                 axis=1)
...
if __name__ == '__main__':
    ...
    colnames = ['office', 'name', 'adr_1', 'adr_2', 'dirs', 'city', 'state', 'zip',
                'start_time', 'end_time',  'start_date', 'end_date', 'appt', 'ocd-id', 'index', 'address_line', 'directions',
