...
class PollingLocationTxt(object):
    ...
    def build_polling_location_txt(self):
        ...
        self.base_df['id'] = self.base_df.apply(
            lambda row: self.create_id(row['index'], row['town'], row['street'], row['city'], row['zip']), axis=1)
    ...
    def write_polling_location_txt(self):
        ...
        plt.drop(['town', 'loc_name', 'street', 'city', 'zip', 'start_date', 'end_date', 'start_time', 'end_time', 'index'], inplace=True, axis=1)
...
if __name__ == '__main__':
    ...
    #drop_box_true =
    state_file='ma_early_voting_info.csv'
    ...
    colnames = ['town', 'loc_name', 'street', 'city', 'zip', 'start_date', 'end_date', 'start_time', 'end_time']
    print len(colnames)
