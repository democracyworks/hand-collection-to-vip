...
state = 'wisconsin'
state_upper = 'Wisconsin'

state_abbreviation = 'wi'
state_abbreviation_upper = 'WI'

utc_offset = ''

early_voting = 'true'

#state_file = 'Wisconsin Early Voting Information - Formatted.csv'
state_file = 'wisconsin_early_voting_info.csv'
#state_file = 'Wisconsin Early Voting Information - Formatted.tsv'
