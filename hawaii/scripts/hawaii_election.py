...
import csv
import config
from hawaii_polling_location import PollingLocationTxt
import pandas as pd
...
class ElectionTxt(object):
    ...
    def registration_deadline(self, index):
        ...
        for index, row in self.state_feed.iterrows():
            if row['office_name'].lower() == config.state:
...
if __name__ == '__main__':
    ...
    early_voting_path ="/Users/danielgilberg/Development/hand-collection-to-vip/hawaii/output/intermediate_pl_for_loc.csv"
    ...
    state_feed_path = "/Users/danielgilberg/Development/hand-collection-to-vip/hawaii/input/" + state_feed_file
