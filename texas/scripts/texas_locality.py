...
if __name__ == '__main__':
    ...
    colnames = ['office_name', 'ocd-division', 'homepage', 'phone', 'email', 'street', 'city', 'state', 'zip', 'start_time', 'end_time', 'start_date',
                'end_date', 'subject_to_change', 'notes', 'index', 'address_line', 'directions',
