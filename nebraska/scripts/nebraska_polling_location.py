...
class PollingLocationTxt(object):
    ...
    def write_polling_location_txt(self):
        ...
        plt.drop(['office_name', 'office_title', 'types', 'ocd_division','description','homepage', 'phone', 'index',
                'email', 'street', 'city', 'state', 'zip', 'start_time',
                'end_time', 'start_date', 'end_date'], inplace=True, axis=1)
...
if __name__ == '__main__':
    ...
    #drop_box_true =
    state_file='nebraska_early_voting_info.csv'
    ...
    colnames = ['office_name', 'office_title', 'types', 'ocd_division','description','homepage', 'phone',
                'email', 'street', 'city', 'state', 'zip', 'start_time',
