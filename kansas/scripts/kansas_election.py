...
class ElectionTxt(object):
    ...
    def write(self):
        ...
        et.to_csv(config.polling_location_output + 'election.txt', index=False, encoding='utf-8')  # send to txt file
        et.to_csv(config.polling_location_output + 'election.csv', index=False, encoding='utf-8')  # send to csv file
