...
def pl():
    ...
    # external_identifier_value,hours,hours_open_id,id,election_administration_id,external_identifier_type,external_identifier_othertype,name,polling_location_ids,state_id,type,other_type
...
class StateTxt(object):
    ...
    def __init__(self):
        pass
        #self.polling_location_ids = pl
        #print self.polling_location_ids
