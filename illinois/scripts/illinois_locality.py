...
class LocalityTxt(object):
    ...
    def write_locality_txt(self):
        ...
        loc.drop(['office_name', 'office_title', 'ocd_division','description','homepage', 'phone',
...
if __name__ == '__main__':
    ...
    colnames = ['ocd_division', 'homepage', 'county', 'loc_name', 'address_one', 'address_two', 'dirs', 'city', 'state', 'zip',
                ...
                'index', 'location_name', 'address_line', 'directions',
    ...
    lt = LocalityTxt(early_voting_df, "Illinois")
    lt.final_build()