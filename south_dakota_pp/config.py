...
state_abbreviation_upper = 'SD'

utc_offset = ''

early_voting = 'false'

state_file = 'South Dakota Polling Places --11-03a.csv'

state_feed = ''

input_path = 'C:\Users\Aaron Garris\democracyworks\hand-collection-to-vip\\south_dakota_pp\input\\'

output = 'C:\Users\Aaron Garris\democracyworks\hand-collection-to-vip\\south_dakota_pp\output\\'
