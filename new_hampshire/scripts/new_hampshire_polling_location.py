...
class PollingLocationTxt(object):
    ...
    def write_polling_location_txt(self):
        ...
        plt.drop(['index','town', 'clerk', 'address', 'phone', 'fax', 'email', 'website', 'polling_place', 'hours', 'election']
                 , inplace=True, axis=1)
...
if __name__ == '__main__':
    ...
    #drop_box_true =
    state_file='new_hampshire_early_voting_info.csv'
    ...
    colnames = ['town', 'clerk', 'address', 'phone', 'fax', 'email', 'website', 'polling_place', 'hours', 'election']
    print len(colnames)
