...
#        return plt
    ...
    def write_polling_location_txt(self):
        ...
        # Drop base_df columns.
        plt.drop(['index', 'office_name', 'official_title', 'ocd_division', 'homepage_url', 'phone', 'email', 'street', 'city',
...
if __name__ == '__main__':
    ...
    s = 'office_name official_title ocd-division homepage_url phone email street city state zip start_time end_time start_date end_date'.split(' ')
    print s
