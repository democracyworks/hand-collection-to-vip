...
state_file = 'new_hampshire_polling_places-clean.csv'

state_feed = ''

input_path = '/home/acg/democracyworks/hand-collection-to-vip/new_hampshire/input/'

output = '/home/acg/democracyworks/hand-collection-to-vip/new_hampshire/output/'
