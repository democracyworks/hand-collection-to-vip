...
if __name__ == '__main__':
    ...
    s = 'county, official_title, types, ocd_division, division_description, homepage_url, phone, location_name, address1, address2, city, state, zip_code, start_time, end_time, start_date, end_date, index, address_line, directions, hours, photo_uri, hours_open_id, is_drop_box, is_early_voting, latitude, longitude, latlng_source, id'.split(', ')
    print s

    colnames = ['county', 'official_title', 'types', 'ocd_division', 'division_description', 'homepage_url',
                'phone', 'location_name', 'address1', 'address2', 'city', 'state', 'zip_code', 'start_time',
                'end_time', 'start_date', 'end_date', 'index', 'address_line', 'directions', 'hours', 'photo_uri',
