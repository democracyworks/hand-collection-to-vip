...
class PollingLocationTxt(object):
    ...
    def get_address_line(self, index, address_1, address_2, city, zip_code):
        ...
        final_line = address + ", " + city_name + ", SD " + zip
        #print final_line
        return final_line
    ...
    def build_polling_location_txt(self):
        ...
        self.base_df['address_line'] = self.base_df.apply(
            lambda row: self.get_address_line(row['index'], row['address_1'],
        ...
        self.base_df['hours_open_id'] = self.base_df.apply(
            lambda row: self.create_hours_open_id(row['index'], row['address_1'],
                                              row['address_2'], row['city'], row['zip_code']), axis=1)
...
#        return plt
    ...
    def write_polling_location_txt(self):
        ...
        # Drop base_df columns.
        plt.drop(['index', 'ocd_division', 'email', 'county', 'location_name', 'address_1', 'address_2', 'city', 'state',
