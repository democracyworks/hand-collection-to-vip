...
import pandas as pd
import config
from ok_polling_location import PollingLocationTxt
import datetime
import re
...
class ScheduleTxt(object):
    ...
    def write_schedule_txt(self):
        ...
        # Drop base_df columns.
        sch.drop(['office_name', 'title', 'ocd_division', 'description', 'homepage', 'phone', 'email', 'loc_name', 'street', 'city', 'state', 'zip',
