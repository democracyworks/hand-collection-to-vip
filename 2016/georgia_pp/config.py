...
state_abbreviation_upper = 'GA'

utc_offset = ''

early_voting = 'false'

state_file = 'Georgia polling places--STABLE-10-31 - Sheet1.csv'

state_feed = ''

input_path = 'C:\Users\Aaron Garris\democracyworks\hand-collection-to-vip\\georgia_pp\input\\'

output = 'C:\Users\Aaron Garris\democracyworks\hand-collection-to-vip\\georgia_pp\output\\'

#source_output = "/home/acg/democracyworks/hand-collection-to-vip/dev_scripts/output/source.txt"

polling_place_columns = ['county', 'official_title', 'ocd_division', 'homepage_url', 'phone', 'email', 'directions',
