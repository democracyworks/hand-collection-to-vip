...
from ga_precinct import PrecinctTxt
...
class StreetSegmentsTxt(object):
    ...
    def odd_even_both(self, index, vf_reg_cass_street_num):
        """Set the odd_even_both value. The value is always both."""
        return 'both'
...
def main():
    """The voter file is read into a dataframe and passed to an instance of the StreetSegment class.
    ...
    # Create dataframe from voter file
