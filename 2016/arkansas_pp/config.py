...
state = 'arkansas'
state_upper = 'Arkansas'

state_abbreviation = 'ar'
state_abbreviation_upper = 'AR'

utc_offset = ''

early_voting = 'false'

state_file = 'Arkansas polling places--STABLE-11-02 - Sheet1 (4).csv'

state_feed = ''

input_path = 'C:\Users\Aaron Garris\democracyworks\hand-collection-to-vip\\arkansas_pp\input\\'

output = 'C:\Users\Aaron Garris\democracyworks\hand-collection-to-vip\\arkansas_pp\output\\'
