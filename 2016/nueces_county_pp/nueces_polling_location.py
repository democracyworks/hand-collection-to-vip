...
class PollingLocationTxt(object):
    ...
    def export_for_schedule_and_locality(self):
        ...
        intermediate_doc = intermediate_doc.drop_duplicates(subset=['start_time', 'end_time',
                                                                     'address_line'])
...
if __name__ == '__main__':
    ...
    usecols = ['office-name', 'ocd_division', 'directions', 'precinct_name', 'loc_name', 'street', 'city', 'state',
                'zip_code', 'start_time', 'end_time', 'notes']

    print len(colnames), len(usecols)
