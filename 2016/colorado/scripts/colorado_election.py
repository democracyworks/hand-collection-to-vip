...
import csv
import config
from colorado_polling_location import PollingLocationTxt
import pandas as pd
...
class ElectionTxt(object):
    ...
    def write(self):
        ...
        et.drop(['loc_name', 'adr_1', 'adr_2', 'adr_3', 'city', 'state', 'zip', 'dirs', 'county', 'services', 'start_date',
...
if __name__ == '__main__':
    ...
    state_feed_path = config.input + "state_feed_info.csv"
