...
#    state_file = 'intermediate_doc.csv'
    ...
    columns = ['county', 'precinct', 'official_title', 'ocd_division', 'homepage_url', 'phone', 'email', 'name',
               'street', 'city', 'state', 'zip_code', 'start_time', 'end_time', 'start_date', 'end_date']

    early_voting_df = pd.read_csv(config.input_path + config.state_file, names=columns, encoding='ISO-8859-1', skiprows=1)
