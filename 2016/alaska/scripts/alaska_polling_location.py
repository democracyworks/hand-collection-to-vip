...
class PollingLocationTxt(object):
    ...
    def create_hours_open_id(self, index, street, city, zip_code):
        ...
        #print index, street, city, zip_code
    ...
    def create_id(self, index, street, city, zip_code):
        """Create id"""
    ...
    def build_polling_location_txt(self):
        ...
        self.base_df['id'] = self.base_df.apply(
            lambda row: self.create_id(row['index'], row['adr_1'], row['city'], row['zip']), axis=1)
    ...
    def write_polling_location_txt(self):
        ...
        plt.drop(['office', 'name', 'adr_1', 'adr_2', 'dirs', 'city', 'state', 'zip',
                'start_time', 'end_time',  'start_date', 'end_date', 'appt', 'ocd-id', 'index'], inplace=True, axis=1)
...
if __name__ == '__main__':
    ...
    #drop_box_true =
    state_file='alaska_early_voting_info.csv'
    ...
    colnames = ['office', 'name', 'adr_1', 'adr_2', 'dirs', 'city', 'state', 'zip',
                'start_time', 'end_time',  'start_date', 'end_date', 'appt', 'ocd-id']
    print len(colnames)
