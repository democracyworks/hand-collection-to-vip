...
class ElectionTxt(object):
    ...
    def write(self):
        ...
        et.drop(['loc_name', 'adr_location_name', 'adr_1', 'adr_2', 'adr_3', 'city', 'state', 'zip', 'dirs', 'services',
...
if __name__ == '__main__':
    ...
    colnames = ['loc_name', 'adr_location_name', 'adr_1', 'adr_2', 'adr_3', 'city', 'state', 'zip', 'dirs', 'services',
                'start_date', 'end_date', 'start_time', 'end_time', 'ev_id', 'locality_id',
                'index', 'address_line', 'directions',
