...
state_abbreviation_upper = 'ME'

utc_offset = ''

early_voting = 'false'

state_file = 'maine_polling_places2.csv'

state_feed = ''

input_path = 'C:\Users\Aaron Garris\democracyworks\hand-collection-to-vip\\maine_pp\input\\'

#output = '/home/acg/democracyworks/hand-collection-to-vip/new_hampshire_pp/output/'

output = 'C:\Users\Aaron Garris\democracyworks\hand-collection-to-vip\\maine_pp\output\\'

#source_output = "/home/acg/democracyworks/hand-collection-to-vip/dev_scripts/output/source.txt"


polling_place_columns = ['cty', 'ocd', 'municipality', 'wp', 'voting_place', 'street', 'start_time', 'end_time', 'start_date', 'end_date']
