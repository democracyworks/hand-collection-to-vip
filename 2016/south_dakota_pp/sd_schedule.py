...
if __name__ == '__main__':
    ...
    s = 'county,official_title,ocd_division,homepage_url,phone,email,precinct,location_name,address1,directions,city,state,zip_code,start_time,end_time,start_date,end_date,precint_notes,index,address_line,hours,photo_uri,hours_open_id,is_drop_box,is_early_voting,latitude,longitude,latlng_source,id'.split(',')
    print s
    colnames = ['county', 'official_title', 'ocd_division', 'homepage_url', 'phone', 'email', 'precinct', 'location_name',
                ...
                'precint_notes', 'index', 'address_line', 'hours', 'photo_uri', 'hours_open_id', 'is_drop_box', 'is_early_voting',
    ...
    #print polling_place_df.hours_open_id

    ScheduleTxt(polling_place_df).write_schedule_txt()
    #ScheduleTxt(polling_place_df).format_for_schedule()