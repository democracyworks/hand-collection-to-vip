...
class PollingLocationTxt(object):
    ...
    def dedupe(self, dupe):
        """#"""
        return dupe.drop_duplicates(subset=['precinct', 'address_line'])
    ...
    def write_polling_location_txt(self):
        ...
        plt = plt.drop_duplicates(subset=['id'])


        # Drop base_df columns.
        plt.drop(['county', 'official_title', 'ocd_division', 'homepage_url', 'phone', 'email', 'precinct', 'location_name',
                'address1', 'directions', 'city', 'state', 'zip_code', 'start_time', 'end_time', 'start_date', 'end_date',
                'precint_notes', 'index'], inplace=True, axis=1)
...
if __name__ == '__main__':
    ...
    s = 'county,official_title,ocd_division,homepage_url,phone,email,precinct,location_name,address1,directions,city,state,zip_code,start_time,end_time,start_date,end_date,precint_notes'.split(',')
    print s
    colnames = ['county', 'official_title', 'ocd_division', 'homepage_url', 'phone', 'email', 'precinct', 'location_name',
                'address1', 'directions', 'city', 'state', 'zip_code', 'start_time', 'end_time', 'start_date', 'end_date',
                'precint_notes']
    ...
    #polling_place_df = polling_place_df[polling_place_df['precinct'].isin(['County wide voting center']) == False]
