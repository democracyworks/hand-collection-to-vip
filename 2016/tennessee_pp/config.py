...
state = 'tennessee'
state_upper = 'Tennessee'

state_abbreviation = 'tn'
state_abbreviation_upper = 'TN'
...
state_file = 'Tennessee--STABLE-11-03b.csv'

state_feed = ''

#input_path = '/home/acg/democracyworks/hand-collection-to-vip/'+ state + '/input/'
input_path = 'C:\Users\Aaron Garris\democracyworks\hand-collection-to-vip\\tennessee_pp\input\\'

#output = '/home/acg/democracyworks/hand-collection-to-vip/' + state + '/output/'
output = 'C:\Users\Aaron Garris\democracyworks\hand-collection-to-vip\\tennessee_pp\output\\'
