...
if __name__ == '__main__':
    ...
    colnames = ['county', 'ocd_division', 'directions', 'precinct', 'name', 'address1', 'city', 'state', 'zip_code',
                'start_time', 'end_time', 'index', 'address_line', 'hours', 'photo_uri', 'hours_open_id', 'is_drop_box',
