...
import csv
import config
from florida_polling_location import PollingLocationTxt
import pandas as pd
...
class ElectionTxt(object):
    ...
    def write(self):
        ...
        et.drop(['county', 'site', 'loc_name', 'adr_1', 'adr_2', 'adr_3', 'city', 'state', 'zip', 'dirs', 'services',
                'start_date', 'end_date', 'start_time', 'end_time', 'index', 'address_line', 'directions',
                'hours', 'photo_uri', 'hours_open_id', 'is_drop_box', 'is_early_voting', 'lat', 'long', 'latlng', 'poll_id'], inplace=True, axis=1)
