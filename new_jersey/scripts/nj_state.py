...
def pl():
    ...
    early_voting_path = "/home/acg/democracyworks/hand-collection-to-vip/new_jersey/output/" + early_voting_file
    ...
    df = pd.read_csv(early_voting_path, names=colnames, encoding='utf-8', skiprows=1, na_values='')
