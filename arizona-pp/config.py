...
state_abbreviation_upper = 'AZ'

utc_offset = ''

early_voting = 'false'

#state_file = 'arizona_early_voting_info.csv'

state_file = 'pima_county_precincts_polling1.csv'

state_feed = ''

#input = '/home/acg/democracyworks/hand-collection-to-vip/arizona-pp/input/'
input_path = 'C:\Users\Aaron Garris\democracyworks\hand-collection-to-vip\\arizona-pp\input\\'

#output = '/home/acg/democracyworks/hand-collection-to-vip/arizona-pp/output/'
output = 'C:\Users\Aaron Garris\democracyworks\hand-collection-to-vip\\arizona-pp\output\\'
...
voter_file_columns = ['vf_source_state', 'vf_county_code', 'vf_county_name', 'vf_cd', 'vf_sd', 'vf_hd', 'vf_township', 'vf_ward',
