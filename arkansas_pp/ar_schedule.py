...
class ScheduleTxt(object):
    ...
    def get_end_time(self):
        """Formats and sets end_time value. Hard coded for election day end time."""
    ...
    def get_start_date(self):
        """Formats start_date. Hard coded election day."""
        return '2016-11-08'
...
if __name__ == '__main__':
    ...
    s = 'county,ocd_division,phone,email,precinct,directions,name,address1,address2,city,state,zip_code,start_time,end_time,index,address_line,hours,photo_uri,hours_open_id,is_drop_box,is_early_voting,latitude,longitude,latlng_source,id'.split(',')
    print s

    colnames = ['county', 'ocd_division', 'phone', 'email', 'precinct', 'directions', 'name', 'address1', 'address2',
                'city', 'state', 'zip_code', 'start_time', 'end_time', 'index', 'address_line', 'hours', 'photo_uri',
