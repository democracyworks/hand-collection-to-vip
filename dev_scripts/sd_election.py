...
def main():
    ...
    early_voting_file = "/home/acg/democracyworks/hand-collection-to-vip/south_dakota/early_voting_input/" + input
...
class ElectionTxt(object):
    ...
    def write_election_txt(self):
        output_path = "/home/acg/democracyworks/hand-collection-to-vip/south_dakota/output/election.txt"
        try:
