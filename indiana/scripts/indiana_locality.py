...
class LocalityTxt(object):
    ...
    def build_locality_txt(self):
        ...
        self.base_df['polling_location_ids'] = self.base_df.apply(
            lambda row: self.create_polling_location_ids(row['source_id']), axis=1)
    ...
    def write_locality_txt(self):
        ...
        loc.drop(['office_name', 'ocd_division', 'description', 'homepage', 'phone', 'email', 'street', 'city', 'state', 'zip',
